...
<head>
    <meta charset="UTF-8">
    <title>EcoRaíces | Editar Administradores</title>
...
<body>
    ...
    <main class="container my-5 py-5">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h1 class="display-5 fw-bold">Gestionar Administradores</h1>
                <p class="lead text-muted">Visualiza y elimina cuentas de administradores.</p>
            </div>
            <a href="superAdminPanel.php" class="btn btn-secondary">Volver al Panel</a>
        </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>¿Estás seguro de que deseas eliminar al administrador <strong id="adminNameToDelete"></strong>? Esta acción no se puede deshacer.</p>
          </div>
