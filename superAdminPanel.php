...
<html lang="es">
    <head>
        ...
        <title>EcoRaíces | Panel de Administración</title>
        <link
    ...
    <body>
        ...
        <main class="container my-5 py-5">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-5">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body text-center p-4">
                            <h5 class="card-title">Editar Administradores</h5>
                            <p class="card-text">
        ...
        <footer class="bg-dark text-light pt-5 pb-4"></footer>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            El administrador a sido creado correctamente!
                        </p>
                    </div>
        ...
        <!-- Script para mostrar el modal de éxito en registro -->
        <script>
